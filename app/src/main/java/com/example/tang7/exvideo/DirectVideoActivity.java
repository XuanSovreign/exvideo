...
public class DirectVideoActivity extends Activity {
            ...
            switch (msg.what) {
                ...
                case 1:
                    if (isFirst) {
                        ...
                        editor.apply();
                        startActivity(new Intent(DirectVideoActivity.this, ConfigActivity.class));
                        finish();
                        isFirst = false;
                    }
                    break;
...
//        Log.e("outPath", "checkFile: ======"+outPath);
        return true;
    }
